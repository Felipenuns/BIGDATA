...
text_files = glob.glob('C:\\Windows\\Temp\\Exec\\Entrega final Concluido. 100%\\data\\problema-dos-autores\\*');
...
w = csv.writer(open('C:\\Windows\\Temp\\Exec\\RES2.csv','w'))
